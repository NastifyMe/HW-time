...
})({"j5PKp":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 58908;
...
document.getElementById('startBtn').addEventListener('click', ()=>{
    animation = setInterval(()=>{
        ...
        if (position === 200 && size === 200) clearInterval(animation);
    }, intervalInput.value);
    let position = 0;
    let size = 100;
});
...
btnStart.addEventListener('click', ()=>{
    ...
    imgClick.addEventListener('click', ()=>{
        if (imgClick) {
            curCount++;
            counter.textContent = `\u{420}\u{430}\u{445}\u{443}\u{43D}\u{43E}\u{43A}: ${curCount}`;
        }
        if (curCount === 10) clearInterval(rundom);
    });
});
...
startTime.addEventListener('click', ()=>{
    ...
    if (setTime.value > 0) setTimeout(()=>{
        alert(`\u{427}\u{430}\u{441} \u{432}\u{438}\u{439}\u{448}\u{43E}\u{432}, \u{43F}\u{440}\u{43E}\u{439}\u{448}\u{43B}\u{43E} ${timer} \u{441}\u{435}\u{43A}.`);
    }, timer * 1000);
});

},{}]},["j5PKp","jOXmm"], "jOXmm", "parcelRequirec022", {})

//# sourceMappingURL=HW-time.e02fbd41.js.map
